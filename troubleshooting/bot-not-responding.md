---
description: 'Diagnose a Telegram bot that does not reply: check token, launch state, commands, pending input, groups, errors,
  and iterations.'
---
...
### Confirm the bot and its status <a href="#1-confirm-the-bot-and-its-status" id="1-confirm-the-bot-and-its-status"></a>
...
### Check the saved command <a href="#2-check-the-saved-command" id="2-check-the-saved-command"></a>
...
### Check whether the bot is waiting <a href="#3-check-whether-the-bot-is-waiting" id="3-check-whether-the-bot-is-waiting"></a>
...
### Read the actual error <a href="#4-read-the-actual-error" id="4-read-the-actual-error"></a>
...
### Check access and resources <a href="#5-check-access-and-resources" id="5-check-access-and-resources"></a>
